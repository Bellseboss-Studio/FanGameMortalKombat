...
public class TerrainChecker : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if(surfaceIndex != surfaceChecker)
        {
            surfaceChecker = surfaceIndex;
            DebugTerrainToConsole();
        }
    }

    void DebugTerrainToConsole()
    {
      
        Debug.Log("index: " + surfaceIndex.ToString() + ", name: " + terrainData.terrainLayers[surfaceIndex].name.ToString());
    }
